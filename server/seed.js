...
const CANDIDATES = [
  ...
  { name: 'Karan Bose',     email: 'karan.bose@email.com',     phone: '+91 99887 76655', role: 'Data Scientist',           status: 'Shortlist',         exp: 3, title: 'Data Analyst',              company: 'Mu Sigma', appliedDate: TODAY, summary: 'Data analyst transitioning to data science.',                                                skills: ['Python', 'ML', 'TensorFlow', 'SQL'] },
  ...
  { name: 'Divya Joshi',    email: 'divya.joshi@email.com',    phone: '+91 82233 44455', role: 'Product Manager',          status: 'Shortlist',         exp: 3, title: 'Business Analyst',          company: 'TCS',      appliedDate: TODAY, summary: 'BA with PM aspirations. Good grasp of product concepts.',                                   skills: ['Figma', 'Analytics', 'Scrum', 'PRDs'] },
  ...
  { name: 'Nandita Rao',    email: 'nandita.rao@email.com',    phone: '+91 87733 66112', role: 'Finance Analyst',   status: 'Shortlist',    exp: 3, title: 'Business Finance Analyst',  company: 'Wipro',      appliedDate: TODAY, summary: 'Finance analyst with some FP&A exposure but limited modelling depth.',                          skills: ['Excel', 'PowerPoint', 'Basic SQL'] },
]
